    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="jianceName">
                       <el-input v-model="ruleForm.jianceName"
                                 placeholder="标题" clearable  :readonly="ro.jianceName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="jianceName">
                           <el-input v-model="ruleForm.jianceName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiancePhoto" label="检测图片" prop="jiancePhoto">
                        <file-upload
                            tip="点击上传检测图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.jiancePhoto?$base.url+ruleForm.jiancePhoto:''"
                            @change="jiancePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiancePhoto" label="检测图片" prop="jiancePhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.jiancePhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="jianceText">
                        <el-input type="textarea"  :readonly="ro.jianceText" v-model="ruleForm.jianceText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jianceText" label="备注" prop="jianceText">
                            <span v-html="ruleForm.jianceText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiancePhoto: [
                              { required: true, message: '检测图片不能为空', trigger: 'blur' },
                          ],
                   jianceTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiance/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jianceCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            jiancePhotoUploadChange(fileUrls){
                this.ruleForm.jiancePhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
