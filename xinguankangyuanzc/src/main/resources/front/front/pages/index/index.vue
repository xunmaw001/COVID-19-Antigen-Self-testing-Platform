...
<view class="title"
    ...
    <text :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#fff","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"40%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
          @tap="onPageTap('xinguankangyuan')">查看更多
    </text>
</view>
<view class="list-box style1"
    ...
    <view @tap="onDetailTap('xinguankangyuan',product.id)" v-for="(product,index) in xinguankangyuanList" :key="index"
          class="list-item"
        ...
        <view
                ...
                class="list-item-title hide1">{{product.xinguankangyuanName}}
        </view>
        <image
                ...
                :src="baseUrl+product.xinguankangyuanPhoto"></image>
    </view>
</view>
        </view>
        <view class="listBox recommend">
...
<view class="title"
    ...
    <text :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#fff","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"40%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
          @tap="onPageTap('fanghuzhishi')">查看更多
    </text>
</view>
<view class="list-box style1"
      :style='{"padding":"40rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('fanghuzhishi',product.id)" v-for="(product,index) in fanghuzhishiList" :key="index"
          class="list-item"
          :style='{"padding":"0","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","borderRadius":"20rpx","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
        <view
                :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="list-item-title hide1">{{product.fanghuzhishiName}}
        </view>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto -10rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.fanghuzhishiPhoto"></image>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let xinguankangyuan = await this.$api.requestCondition('xinguankangyuan','gexingtuijian',val);

            this.xinguankangyuanList = xinguankangyuan.data.list
            this.xinguankangyuanList.forEach(function(item, index) {
            ...
            let fanghuzhishi = await this.$api.requestCondition('fanghuzhishi','gexingtuijian',valA);

            this.fanghuzhishiList = fanghuzhishi.data.list
            this.fanghuzhishiList.forEach(function(item, index) {
