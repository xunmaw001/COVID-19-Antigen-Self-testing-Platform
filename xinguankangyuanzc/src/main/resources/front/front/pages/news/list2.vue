...
<view class="news-box5"
    ...
    <view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item"
          :style='{"padding":"20rpx 12rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"12rpx 1%","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"10rpx","borderWidth":"2rpx","width":"100%","borderStyle":"solid","height":"auto"}'
