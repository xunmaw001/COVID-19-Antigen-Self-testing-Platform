...
public class FanghuzhishiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FanghuzhishiCollectionEntity() {

	}

	public FanghuzhishiCollectionEntity(T t) {
		try {
