...
public class XinguankangyuanLiuyanView extends XinguankangyuanLiuyanEntity implements Serializable {
	...
	public XinguankangyuanLiuyanView() {

	}

	public XinguankangyuanLiuyanView(XinguankangyuanLiuyanEntity xinguankangyuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xinguankangyuanLiuyanEntity);
	...
	public String toString() {
		return "XinguankangyuanLiuyanView{" +
