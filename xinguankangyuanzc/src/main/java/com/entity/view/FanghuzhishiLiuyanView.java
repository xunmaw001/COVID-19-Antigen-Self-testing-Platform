...
public class FanghuzhishiLiuyanView extends FanghuzhishiLiuyanEntity implements Serializable {
	...
	public FanghuzhishiLiuyanView() {

	}

	public FanghuzhishiLiuyanView(FanghuzhishiLiuyanEntity fanghuzhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, fanghuzhishiLiuyanEntity);
