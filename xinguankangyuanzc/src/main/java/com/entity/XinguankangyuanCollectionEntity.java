...
public class XinguankangyuanCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XinguankangyuanCollectionEntity() {

	}

	public XinguankangyuanCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "XinguankangyuanCollection{" +
            ", id=" + id +
